    ...
    return(
                ...
                <div className="flex flex-col">
                    <p className="font-semibold text-gray-600 mb-2">
                     ...
                     <div className="rounded-md border border-gray-300 h-full bg-layer relative overflow-hidden">
                        <img src={image?URL.createObjectURL(image):""} className="rounded-md-full object-cover"/>
                     </div>
            ...
            {resultImage&&(
                <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-4">
                    ...
                    <a href={resultImage} download className="cursor-pointer py-3 px-6 text-center text-white font-semibold rounded-full bg-gradient-to-r from-purple-500 to-indigo-500 shadow:lg hover:from-purple-600 hover:to-indigo-600 transition duration-300 ease-in-out hover:scale-105">
                        Download Image
                    </a>
                </div>
            )}
